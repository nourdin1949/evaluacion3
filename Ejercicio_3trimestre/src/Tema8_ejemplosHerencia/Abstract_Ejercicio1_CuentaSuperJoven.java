 ...
 */
public class Abstract_Ejercicio1_CuentaSuperJoven extends Abstract_Ejercicio1_CuentaJoven {
    /*
    • La clase CuentaMuyJoven será una clase derivada de la clase CuentaJoven. 
                ¿Qué ocurre cuando intentas crear esta clase?.
            NO PODREMOS CREARLA YA QUE ES UN SUBVCLASE DE UNA CLASE FINAL.
    Es , no puede existir esta clase.
    */
}
