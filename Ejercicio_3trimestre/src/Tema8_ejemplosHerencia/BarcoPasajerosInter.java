 ...
 */
public class BarcoPasajerosInter extends BarcoPadreInter {
    private String texto;
    public BarcoPasajerosInter() {
    }

   
    public BarcoPasajerosInter(String texto, double eslora, int numeroCamas) {
        super(eslora, numeroCamas);
        this.texto = texto;
    }

    @Override
    public String alarma(){
        return "Soy la alarma de barco pasajeros";
    }
    @Override
